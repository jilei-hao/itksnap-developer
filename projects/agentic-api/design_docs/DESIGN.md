...
This document explains *what* the system is and *why* it is built the way it is. For the
*how* (files, functions, line numbers, the exact algorithms) see [`IMPLEMENTATION.md`](./IMPLEMENTATION.md).
Two figures accompany this doc:
